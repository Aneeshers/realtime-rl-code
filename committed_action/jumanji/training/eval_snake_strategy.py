"""Strategy-bin evaluation for the SnakeKT adaptive gating policy.
...
Usage:
  python -m jumanji.training.eval_snake_strategy \\
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--wandb_project", type=str, default="snake_strategy_eval")
    p.add_argument("--wandb_entity",  type=str, default=None)
    p.add_argument("--no_wandb",      action="store_true")
    p.add_argument("--output_dir",    type=str, default="snake_strategy_eval_results")
    return p.parse_args()
